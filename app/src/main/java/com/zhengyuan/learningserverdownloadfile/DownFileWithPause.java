...
public class DownFileWithPause extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.downfilewithpause);
...
//                    output.flush();
        ...
        protected void onPreExecute() {
            ...
            Toast.makeText(DownFileWithPause.this, "开始下载", Toast.LENGTH_SHORT).show();
            super.onPreExecute();
        }
        ...
        protected void onProgressUpdate(Integer... values) {
            ...
            Log.i("test==", "downloading  " + values[0]);
            //更新界面进度条
        ...
        protected void onPostExecute(Long aLong) {
            Log.i("test==", "download success " + aLong);
            Toast.makeText(DownFileWithPause.this, "下载结束", Toast.LENGTH_SHORT).show();
